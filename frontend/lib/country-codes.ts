export interface CountryCode {
  name: string;
  code: string; // dial code incl. leading +
  iso: string;  // ISO-3166 alpha-2
  flag: string; // emoji
}

// Sorted alphabetically by country name. Dial codes per ITU-T E.164.
...
export const DEFAULT_COUNTRY_ISO = "IN"; // India (+91) default
